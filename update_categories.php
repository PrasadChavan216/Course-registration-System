...
{  
        ...
        $response=array();  
        $sql="SELECT * FROM categories WHERE cat_id=:update_request_id";
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-body d-flex justify-content-center">
                              ...
                              <form class="row w-100 text-center" method="POST"  action="update_categories.php"> 
                                <!-- Name input -->
                                <span>
                                    <?php
                                    if (isset($message)) {
                                ...
                                <input type="hidden" name="cat_id" value="<?php if(isset($cat_id)){echo $cat_id;}?>">
                                  <input type="text" id="form5Example1"  value="<?php if(isset($cat_name)){echo $cat_name;}?>" name="cat_name" class="form-control"/>
                                </div>
                            </div>
                                <div class="col-md-12">
                                <div class="form-outline mb-4">
